defmodule Tasktracker.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{UserID: 42, admin: true, email: "some email", name: "some name"}
    @update_attrs %{UserID: 43, admin: false, email: "some updated email", name: "some updated name"}
    @invalid_attrs %{UserID: nil, admin: nil, email: nil, name: nil}
